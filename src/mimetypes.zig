...
test "guess-ext" {
    ...
    testing.expectEqualSlices(u8, "image/png", registry.getTypeFromFilename("an-image.png").?);
    testing.expectEqualSlices(u8, "application/javascript", registry.getTypeFromFilename("wavascript.js").?);
}
...
test "guess-ext-from-file" {
    ...
    testing.expectEqualSlices(u8, "application/x-7z-compressed", registry.getTypeFromFilename("archive.7z").?);
}
